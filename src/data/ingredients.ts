...
export const allIngredients: Ingredient[] = [
  ...
  { id:'chickenbroth',    name:'Chicken broth',      image:'/assets/ingredients/chickenbrothNoBg.png',  quantity:'2 cups', location: 'fridge' },
  { id:'beefstock',       name:'Beef stock',         image:'/assets/ingredients/beefstockNoBg.png',     quantity:'2 cups', location: 'fridge' },
  { id:'vegetablesbroth', name:'Vegetable broth',    image:'/assets/ingredients/vegetables_broth.png', quantity:'2 cups', location: 'fridge' },
  { id:'creammushroom',   name:'Cream of mushroom',  image:'/assets/ingredients/CreamofmushroomNoBg.png',quantity:'1 can', location: 'fridge' },
  ...
  { id:'tomatopaste',     name:'Tomato paste',       image:'/assets/ingredients/tomato_paste.png',     quantity:'2 tbsp', location: 'fridge' },
  { id:'tomatosauce',     name:'Tomato sauce',       image:'/assets/ingredients/spag_sauce.png',       quantity:'1 cup', location: 'fridge' },
  { id:'spagsauce',       name:'Spaghetti sauce',    image:'/assets/ingredients/spag_sauce.png',       quantity:'1 jar', location: 'fridge' },
